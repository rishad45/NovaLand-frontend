...
const AllBlockedAdmins = () => {
    ...
    const onButtonClick = (e, row) => {
        ...
        console.log(row);
        axiosPrivate.post('/admin/unblock-admin', {
            adminId: row.id,
        }).then((res) => {
            setUnblocked(true);
        })
    };
    let endpoint = '/admin/get-all-blockedAdmins';
    const columns = [
        { field: 'id', headerName: 'ID', width: 250 },
        { field: 'name', headerName: 'ADMIN NAME', width: 250 },
        { field: 'email', headerName: 'EMAIL', width: 250 },
        { field: 'superAdmin', headerName: 'SUPERADMIN', width: 150 },
        {
...
export default AllBlockedAdmins